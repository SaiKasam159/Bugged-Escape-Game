...
onready var links = $Link		# A slightly easier reference to the links
...
func _process(_delta: float) -> void:
	...
	links.rotation = self.position.angle_to_point(tip_loc) 
	$Tip.rotation = self.position.angle_to_point(tip_loc) 
